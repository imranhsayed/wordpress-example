 ...
 * }
 * @variations {
 *   "default": {"image_id": 1, "content": "<h3>High Rigidity</h3><p>Advanced material tools offer integrated compliance for consistent, repeatable processing, and can be easily programmed and mounted for various operations.</p>"},
 *   "simple": {"image_id": 1, "content": "<h3>Precision Engineering</h3><p>State-of-the-art manufacturing processes ensure the highest quality standards.</p>"}
 * }
