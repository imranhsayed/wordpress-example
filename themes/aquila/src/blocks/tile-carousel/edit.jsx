...
export default function Edit({ attributes, setAttributes, clientId }) {
	...
	return (
		<>
			<InspectorControls>
				<PanelBody
					title={__('Carousel Settings', 'aquila-theme')}
					className="tile-carousel-editor__settings-panel"
				>
					<BaseControl
						__nextHasNoMarginBottom
						label={__('Slides Management', 'aquila-theme')}
					...
					<BaseControl
						__nextHasNoMarginBottom
						label={__('Toggle Edit Mode', 'aquila-theme')}
						id="edit-mode-toggle"
					>
						<Button
							variant="secondary"
						...
						{!editMode && (
							<BaseControl
								label={__(
									'Please enable the edit mode, to continue editing the card.',
									'aquila-theme'
								)}
								__nextHasNoMarginBottom
								id="slides-management"
