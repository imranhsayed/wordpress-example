<?php
/**
 * Pattern Media text interactive
 *
 * Title: Media Text Interactive
 * Slug: one-novanta-theme/media-text-interactive
...
<div class="wp-block-columns alignwide elementary-media-text-interactive">
	...
	<div class="wp-block-column is-vertically-aligned-center"><!-- wp:heading -->
		<h2 class="wp-block-heading"><?php esc_html_e( 'Title', 'one-novanta-theme' ); ?></h2>
		<!-- /wp:heading -->

		<!-- wp:paragraph -->
		<p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Blanditiis obcaecati vel impedit sed commodi error eveniet veniam. Delectus illum quis porro expedita quibusdam officiis iste est dicta assumenda, esse natus.</p>
		<!-- /wp:paragraph -->
		...
		<div class="wp-block-buttons"><!-- wp:button {"className":"elementary-media-text-interactive"} -->
			<div class="wp-block-button elementary-media-text-interactive"><a
					class="wp-block-button__link wp-element-button"><?php esc_html_e( 'Play', 'one-novanta-theme' ); ?></a></div>
			<!-- /wp:button -->
		</div>
		<!-- /wp:buttons -->
	</div>
