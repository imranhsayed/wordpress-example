/**
 * ProductVariationRelatedModules Class.
 */
export default class ProductVariationRelatedModules extends HTMLElement {
	/**
	 * Constructor.
	 */
	constructor() {
	...
	onVariationDataGet( variation, response ) {
		...
		this.innerHTML = response.data.related_module ?? '';
 ...
 * Initialize.
 */
customElements.define( 'ati-product-variation-related-modules', ProductVariationRelatedModules );
